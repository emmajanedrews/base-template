...
• A personally-designed business plan, developed specifically to meet you goals.<br>
• Direct access to me for planning and transactional support<br>
• Access to a settlement coordinator to assist you in your transactions<br>
• Regular masterminding with top agents<br>
...
<form method="post" class="home-value cta-forms" action="http://formspree.io/matt@hhande.com" onsubmit="return setReturn()">
    <fieldset>
        <p id="thanks"></p>
